...
Code quality assurance checklist - based on Duck Book: https://best-practice-and-impact.github.io/qa-of-code-guidance/checklist_lower.html

This is an itemised checklist for the Lower QA checklist (low complexity and risk category) 

Commit/tag the review was completed for:

Please delete the sections below that are not relevant:
